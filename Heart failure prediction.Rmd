...
For the wrapper, the programming language Java has been used. The Java wrapper is made and tested on Java version 16. Via the command line, a patient's age, serum creatinine and serum sodium value can be given. The wrapper will follow the model made in Weka version 3.9.5. 
...
With the machine learning results and J48 scoring 77.93% accuracy.The overall result is not what should be expected to be used in hospitals.
